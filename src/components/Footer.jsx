  ...
  return (
    <footer className="footer-premium">
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-14">
        <div className="flex flex-col gap-6">
          <a href="#hero" className="flex items-center gap-4">
            ...
            <div>
              <div className="footer-title">RoseGold Nights</div>
              <div className="footer-subtitle">Modern Glam Events</div>
            </div>
          </a>
      ...
      <div className="footer-bottom">
        © <span id="year">{new Date().getFullYear()}</span> RoseGold Nights. All rights reserved.
      </div>
    </footer>
  );
}
